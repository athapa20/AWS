'use strict';
  ...
  const coordserver="https://xspb6y6wm7.execute-api.us-east-1.amazonaws.com/default/CoordServer-dev-getCoordServer";

  //ten websites that used for random website

  module.exports.getproxy = async function (event) {
